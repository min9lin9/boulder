...
const matrix: readonly MatrixRow[] = [
  ...
  { id: "workflow_retry_preserves_revision", status: "enforced", evidence: ["test/v2-work-durable.test.ts", "fixtures/v2-work/valid-ref-e-work-01.json"] },
  { id: "workflow_critique_material_change_creates_revision", status: "enforced", evidence: ["test/v2-work-durable.test.ts", "fixtures/v2-work/valid-ref-e-work-01.json"] },
  { id: "workflow_completion_requires_terminal_receipt", status: "enforced", evidence: ["test/v2-work-durable.test.ts", "fixtures/v2-work/valid-ref-e-work-01.json"] },
