...
const matrix: readonly MatrixRow[] = [
  ...
  { id: "contract_procedure_rejects_unknown_field", status: "enforced", evidence: ["test/v2-contracts.test.ts", "test/v2-cli-e2e.test.ts", "fixtures/v2-kernel"] },
  { id: "contract_procedure_requires_bounded_loop", status: "planned", evidence: ["REF-E-SOP-01"] },
  { id: "boundary_procedure_must_not_reference_runtime_literal", status: "planned", evidence: ["REF-E-SOP-01"] },
  { id: "contract_runtime_event_rejects_unknown_terminal", status: "planned", evidence: ["REF-PR-2"] },
  { id: "contract_gate_answer_requires_idempotency_key", status: "enforced", evidence: ["test/plan-state.test.ts"] },
  { id: "workflow_acceptance_is_not_completion", status: "enforced", evidence: ["test/v2-execution.test.ts"] },
  { id: "workflow_retry_preserves_revision", status: "enforced", evidence: ["test/plan-state.test.ts"] },
  { id: "workflow_critique_material_change_creates_revision", status: "enforced", evidence: ["test/plan-state.test.ts"] },
  { id: "workflow_completion_requires_terminal_receipt", status: "enforced", evidence: ["test/plan-state.test.ts", "test/plan-approval.test.ts"] },
